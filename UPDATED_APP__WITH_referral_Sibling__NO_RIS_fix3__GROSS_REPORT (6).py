...
def _render_marketing_gross_report(df_f: pd.DataFrame):
    ...
    with st.expander("Breakdowns (optional): Academic Counsellor-wise & Date-wise"):
        ...
        if mode == "MTD":
            ...
            m_sched = (df_view["_cal_resched_d"].notna() | (df_view["_cal_resched_d"].isna() & df_view["_fc_sched_d"].notna()))
        ...
        if ac_col is not None:
            ...
            ac_df = ac_df.fillna(0).astype(int).sort_values(by="Deals", ascending=False)
